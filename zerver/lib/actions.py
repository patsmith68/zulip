...
def recipient_for_user_profiles(user_profiles, not_forged_mirror_message,
    ...
    # type: (Iterable[UserProfile], bool, Optional[UserProfile], UserProfile) -> Recipient
...
def check_message(sender, client, message_type_name, subject_name,
    ...
    # type: (UserProfile, Client, Text, Optional[Text], Text, Optional[Sequence[Text]], Optional[Realm], bool, Optional[float], Optional[UserProfile], Optional[Text], Optional[Text], Optional[Sequence[UserProfile]]) -> Dict[str, Any]
    stream = None
