...
def convert_channel_data(channel_data: List[ZerverFieldsT],
    ...
    for channel_dict in channel_data_list:
        ...
        stream = build_stream(
            ...
            # Can be used for advertising purpose of stream, making announcements as
...
def write_emoticon_data(realm_id: int,
    ...
    In our data_dir we have a pretty simple setup:
        ...
        The exported JSON file will have emoji rows if it contains any custom emoji
            {"type":"emoji","emoji":{"name":"peerdium","image":"exported_emoji/h15ni7kf1bnj7jeua4qhmctsdo/image"}}
            {"type":"emoji","emoji":{"name":"tick","image":"exported_emoji/7u7x8ytgp78q8jir81o9ejwwnr/image"}}
