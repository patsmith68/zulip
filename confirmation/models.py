...
from zerver.models import PreregistrationUser, EmailChangeStatus, MultiUserInvitation
...
def get_object_from_key(confirmation_key):
    # type: (str) -> Union[MultiUserInvitation, PreregistrationUser, EmailChangeStatus]
